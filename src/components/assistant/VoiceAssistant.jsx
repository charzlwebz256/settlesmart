...
User question: "${question}"`,
  ...
  return (
    <button
      ...
      disabled={loading}
      className={cn(
        'fixed bottom-20 right-20 md:bottom-6 md:right-20 z-40 w-10 h-10 rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 flex items-center justify-center',
        isListening || loading
