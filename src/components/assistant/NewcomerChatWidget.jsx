      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-20 right-32 md:bottom-6 md:right-32 z-40 w-10 h-10 rounded-full bg-primary shadow-lg shadow-primary/30 flex items-center justify-center hover:bg-primary/90 transition-colors"
          >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-20 right-32 md:bottom-6 md:right-32 z-40 w-[calc(100vw-2rem)] max-w-sm h-[520px] bg-card rounded-2xl shadow-2xl border border-border/50 flex flex-col overflow-hidden"
          >
            {/* Header */}
